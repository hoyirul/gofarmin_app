...
class ChangeMemberProfileScreen extends StatefulWidget {
  const ChangeMemberProfileScreen({super.key});

  @override
  State<ChangeMemberProfileScreen> createState() =>
      _ChangeMemberProfileScreenState();
}

class _ChangeMemberProfileScreenState extends State<ChangeMemberProfileScreen> {
          ...
          child: Column(
            children: [
              ...
              ButtonComponent(
                  ...
                  button: TextButton(
                      onPressed: () {
                        profileController.updateProfile('member');
                      },
                      child: const Text(
                        'Update',
                        style: TextStyle(
