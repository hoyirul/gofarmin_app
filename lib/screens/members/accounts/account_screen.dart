...
import 'package:gofarmin_app/screens/members/accounts/change_password_screen.dart';
import 'package:gofarmin_app/screens/members/accounts/change_profile_screen.dart';
...
class AccountMemberScreen extends StatefulWidget {
  const AccountMemberScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              InkWell(
                onTap: () {
                  Get.off(const ChangeMemberProfileScreen());
                },
              ...
              InkWell(
                onTap: () {
                  Get.off(const ChangeMemberPasswordScreen());
                },
                child: const SettingComponentFeatures(
