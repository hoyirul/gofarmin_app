...
class RegisterAgricultureGovScreen extends StatefulWidget {
  const RegisterAgricultureGovScreen({super.key});

  @override
  State<RegisterAgricultureGovScreen> createState() =>
      _RegisterAgricultureGovScreenState();
}

class _RegisterAgricultureGovScreenState
    extends State<RegisterAgricultureGovScreen> {
          ...
          child: Column(
            children: [
              ...
              ButtonComponent(
                  ...
                  button: TextButton(
                      onPressed: () =>
                          authController.authRegister('agriculture'),
                      child: const Text(
                        'Sign up',
                        style: TextStyle(
                            fontSize: 14,
