...
class ChangeInvestorPasswordScreen extends StatefulWidget {
  const ChangeInvestorPasswordScreen({super.key});

  @override
  State<ChangeInvestorPasswordScreen> createState() =>
      _ChangeInvestorPasswordScreenState();
}

class _ChangeInvestorPasswordScreenState
    extends State<ChangeInvestorPasswordScreen> {
          ...
          child: Column(
            children: [
              ...
              ButtonComponent(
                  ...
                  button: TextButton(
                      onPressed: () {
                        profileController.updatePassword('investor');
                      },
                      child: const Text(
                        'Update',
                        style: TextStyle(
