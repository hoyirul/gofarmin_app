...
class ChangeInvestorProfileScreen extends StatefulWidget {
  const ChangeInvestorProfileScreen({super.key});

  @override
  State<ChangeInvestorProfileScreen> createState() =>
      _ChangeInvestorProfileScreenState();
}

class _ChangeInvestorProfileScreenState
    extends State<ChangeInvestorProfileScreen> {
          ...
          child: Column(
            children: [
              ...
              ButtonComponent(
                  ...
                  button: TextButton(
                      onPressed: () {
                        profileController.updateProfile('investor');
                      },
                      child: const Text(
                        'Update',
                        style: TextStyle(
