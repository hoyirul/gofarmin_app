...
import 'package:gofarmin_app/screens/investors/auth/register_screen.dart';
...
class LoginInvestorScreen extends StatefulWidget {
  const LoginInvestorScreen({super.key});
          ...
          child: Column(
            children: [
              ...
              ButtonComponent(
                  ...
                  button: TextButton(
                      onPressed: () {
                        authController.authLogin('investor');
                      },
                      child: const Text(
                        'Sign in',
                        style: TextStyle(
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Get.offAll(const RegisterInvestorScreen());
                    },
                    child: const Text(
                      'Sign up',
                      style: TextStyle(
