...
class RegisterInvestorScreen extends StatefulWidget {
  const RegisterInvestorScreen({super.key});

  @override
  State<RegisterInvestorScreen> createState() => _RegisterInvestorScreenState();
}
          ...
          child: Column(
            children: [
              ...
              ButtonComponent(
                  ...
                  button: TextButton(
                      onPressed: () => authController.authRegister('investor'),
                      child: const Text(
                        'Sign up',
                        style: TextStyle(
                            fontSize: 14,
