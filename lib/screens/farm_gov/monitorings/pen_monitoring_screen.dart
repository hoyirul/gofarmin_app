...
class PenMonitoringFarmGovScreen extends StatefulWidget {
  final int id;
  const PenMonitoringFarmGovScreen({super.key, required this.id});

  @override
  State<PenMonitoringFarmGovScreen> createState() =>
      _PenMonitoringFarmGovScreenState();
}

class _PenMonitoringFarmGovScreenState
    extends State<PenMonitoringFarmGovScreen> {
  MemberController memberController = Get.put(MemberController());
  List<TimelineItem> items = [
    TimelineItem(title: "Kebersihan Kandang Ternak", isCompleted: true),
    TimelineItem(title: "Kebersihan Air Minum", isCompleted: false),
    TimelineItem(title: "Kebersihan Hewan Ternak", isCompleted: true),
    TimelineItem(title: "Fogging Tempat Ternak", isCompleted: false),
  ];
