...
class RegisterFarmGovScreen extends StatefulWidget {
  const RegisterFarmGovScreen({super.key});

  @override
  State<RegisterFarmGovScreen> createState() => _RegisterFarmGovScreenState();
}

class _RegisterFarmGovScreenState extends State<RegisterFarmGovScreen> {
          ...
          child: Column(
            children: [
              ...
              ButtonComponent(
                  ...
                  button: TextButton(
                      onPressed: () => authController.authRegister('farm'),
                      child: const Text(
                        'Sign up',
                        style: TextStyle(
                            fontSize: 14,
