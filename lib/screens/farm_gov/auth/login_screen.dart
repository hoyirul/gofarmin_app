...
import 'package:gofarmin_app/screens/farm_gov/auth/register_screen.dart';
...
class LoginFarmGovScreen extends StatefulWidget {
  const LoginFarmGovScreen({super.key});

  @override
  State<LoginFarmGovScreen> createState() => _LoginFarmGovScreenState();
}

class _LoginFarmGovScreenState extends State<LoginFarmGovScreen> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Get.offAll(const RegisterFarmGovScreen());
                    },
                    child: const Text(
                      'Sign up',
                      style: TextStyle(
