...
import 'package:gofarmin_app/screens/farm_gov/accounts/change_password_screen.dart';
import 'package:gofarmin_app/screens/farm_gov/accounts/change_profile_screen.dart';
import 'package:gofarmin_app/screens/farm_gov/home/home_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AccountFarmGovScreen extends StatefulWidget {
  const AccountFarmGovScreen({super.key});

  @override
  State<AccountFarmGovScreen> createState() => _AccountFarmGovScreenState();
}

class _AccountFarmGovScreenState extends State<AccountFarmGovScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              InkWell(
                onTap: () {
                  Get.off(const ChangeFarmGovProfileScreen());
                },
              ...
              InkWell(
                onTap: () {
                  Get.off(const ChangeFarmGovPasswordScreen());
                },
                child: const SettingComponentFeatures(
